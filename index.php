            ...
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-lg-9">
                    <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
                        <strong class="d-block py-2"><?php echo $totalRegistros; ?> Items found </strong>
                        <div class="ms-auto">
                            <form action="index.php" id="ordenForm" method="get" onchange="submitForm()">
                                ...
                                <label for="cbx-orden" class="form-label">Sort by</label>

                                <select class="form-select d-inline-block w-auto pt-1 form-select-sm" name="orden" id="orden">
                                    <option value="precio_alto" <?php echo ($orden === 'precio_alto') ? 'selected' : ''; ?>>Price: High to Low</option>
                                    <option value="precio_bajo" <?php echo ($orden === 'precio_bajo') ? 'selected' : ''; ?>>Price: Low to High</option>
                                    <option value="asc" <?php echo ($orden === 'asc') ? 'selected' : ''; ?>>Name A-Z</option>
                                    <option value="desc" <?php echo ($orden === 'desc') ? 'selected' : ''; ?>>Name Z-A</option>
                                </select>
                            </form>
                        </div>
                    </header>
                        ...
                        <?php foreach ($resultado as $row) { ?>
                            <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
                                <div class="card w-100 my-2 shadow-2-strong">
                                    ...
                                    <?php
                                   $id = $row['id'];
                                   $imagen = "images/productos/$id/PRINT1.jpg";
                                   ...
                                   if (!file_exists($imagen)) {
                                    ...
                                    <div class="card-footer bg-transparent">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a class="btn btn-success" onClick="addProducto(<?php echo $row['id']; ?>)">Add</a>


                                            <div class="btn-group">
                                            <a href="details.php?slug=<?php echo $row['slug']; ?>" class="btn btn-primary">Details</a>
